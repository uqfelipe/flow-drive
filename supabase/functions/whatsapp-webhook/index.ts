    ...
    if (nt === "menu_buttons") {
      ...
      if (buttons.length > 0) {
        ...
        try {
          ...
          await sendWhatsAppMenu(inst, phone, "button", menuText, { choices: btnChoices }, await sendWhatsAppMenu(inst, phone, "button", menuText, { choices: btnChoices }, cfg.imageButton ? { mediaUrl: cfg.imageButton } : {}););
        } catch (_) {
          // Fallback to text
