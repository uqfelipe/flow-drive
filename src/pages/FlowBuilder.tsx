      ...
      <div className="flex flex-col h-[calc(100vh-3.5rem)]">
        ...
        <div className="flex items-center justify-between px-4 py-2 border-b border-border bg-white dark:bg-card gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="ghost" size="sm" className="h-8 text-xs text-destructive hover:text-destructive" onClick={handleFormat} title="Formatar">
              <RotateCcw className="h-3.5 w-3.5 mr-1.5" /> Formatar
            </Button>
