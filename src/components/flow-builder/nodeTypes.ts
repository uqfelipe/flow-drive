...
import {
  ...
  Image, Mic, Video, File, Sticker, MapPin, Contact, Car,
  Type, Hash, Mail, Calendar, Phone, User, CreditCard,
  GitBranch, Clock, Timer, Variable,
  List, MapPinned, Keyboard, RotateCcw,
} from "lucide-react";
...
export const nodeTypes: NodeTypeConfig[] = [
  ...
  { type: "menu_buttons", label: "Menu Respostas", category: "menu", icon: SquareMousePointer, description: "Menu com botões interativos", color: "#3B82F6", defaultConfig: { buttons: [{ text: "Botão 1", type: "REPLY" }, { text: "Botão 2", type: "REPLY" }], imageButton: "" } },
